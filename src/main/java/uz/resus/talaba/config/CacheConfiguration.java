package uz.resus.talaba.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, uz.resus.talaba.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, uz.resus.talaba.repository.UserRepository.USERS_BY_EMAIL_CACHE);
